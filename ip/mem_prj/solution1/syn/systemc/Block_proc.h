...
struct Block_proc : public sc_module {
    ...
    sc_signal< sc_lv<4> > in_V_keep_V_0_data_out;
    ...
    sc_signal< sc_lv<4> > in_V_keep_V_0_payload_A;
    sc_signal< sc_lv<4> > in_V_keep_V_0_payload_B;
    ...
    sc_signal< sc_lv<4> > in_V_strb_V_0_data_out;
    ...
    sc_signal< sc_lv<4> > in_V_strb_V_0_payload_A;
    sc_signal< sc_lv<4> > in_V_strb_V_0_payload_B;
    ...
    sc_signal< sc_lv<4> > out_V_keep_V_1_data_out;
    ...
    sc_signal< sc_lv<4> > out_V_keep_V_1_payload_A;
    sc_signal< sc_lv<4> > out_V_keep_V_1_payload_B;
    ...
    sc_signal< sc_lv<4> > out_V_strb_V_1_data_out;
    ...
    sc_signal< sc_lv<4> > out_V_strb_V_1_payload_A;
    sc_signal< sc_lv<4> > out_V_strb_V_1_payload_B;
    ...
    sc_signal< sc_lv<1> > tmp_1_fu_124_p1;
    sc_signal< sc_lv<1> > tmp_1_reg_136;
    sc_signal< sc_lv<1> > tmp_8_fu_118_p2;
    sc_signal< sc_logic > grp_mem_write_fu_74_ap_start;
    sc_signal< sc_logic > grp_mem_write_fu_74_ap_done;
    sc_signal< sc_logic > grp_mem_write_fu_74_ap_idle;
    sc_signal< sc_logic > grp_mem_write_fu_74_ap_ready;
    sc_signal< sc_lv<32> > grp_mem_write_fu_74_out_r_TDATA;
    sc_signal< sc_logic > grp_mem_write_fu_74_out_r_TVALID;
    sc_signal< sc_logic > grp_mem_write_fu_74_out_r_TREADY;
    sc_signal< sc_lv<4> > grp_mem_write_fu_74_out_r_TKEEP;
    sc_signal< sc_lv<4> > grp_mem_write_fu_74_out_r_TSTRB;
    sc_signal< sc_lv<1> > grp_mem_write_fu_74_out_r_TUSER;
    sc_signal< sc_lv<1> > grp_mem_write_fu_74_out_r_TLAST;
    sc_signal< sc_lv<1> > grp_mem_write_fu_74_out_r_TID;
    sc_signal< sc_lv<1> > grp_mem_write_fu_74_out_r_TDEST;
    sc_signal< sc_lv<3> > grp_mem_write_fu_74_test_init_arr_V_address0;
    sc_signal< sc_logic > grp_mem_write_fu_74_test_init_arr_V_ce0;
    sc_signal< sc_logic > grp_mem_read_fu_96_ap_start;
    sc_signal< sc_logic > grp_mem_read_fu_96_ap_done;
    sc_signal< sc_logic > grp_mem_read_fu_96_ap_idle;
    sc_signal< sc_logic > grp_mem_read_fu_96_ap_ready;
    sc_signal< sc_logic > grp_mem_read_fu_96_in_r_TVALID;
    sc_signal< sc_logic > grp_mem_read_fu_96_in_r_TREADY;
    sc_signal< sc_logic > ap_reg_grp_mem_write_fu_74_ap_start;
    sc_signal< bool > ap_block_state1_ignore_call1;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_logic > ap_reg_grp_mem_read_fu_96_ap_start;
    sc_signal< bool > ap_block_state1_ignore_call0;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<2> > tmp_fu_114_p1;
    ...
    void thread_grp_mem_read_fu_96_ap_start();
    void thread_grp_mem_read_fu_96_in_r_TVALID();
    void thread_grp_mem_write_fu_74_ap_start();
    void thread_grp_mem_write_fu_74_out_r_TREADY();
    ...
    void thread_tmp_1_fu_124_p1();
    void thread_tmp_8_fu_118_p2();
    void thread_tmp_fu_114_p1();
