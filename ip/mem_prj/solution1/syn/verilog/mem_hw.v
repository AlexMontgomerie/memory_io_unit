...
(* CORE_GENERATION_INFO="mem_hw,hls_ip_2017_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=800.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.881500,HLS_SYN_LAT=12,HLS_SYN_TPT=13,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=550,HLS_SYN_LUT=1067}" *)
...
wire   [31:0] Block_proc_U0_out_r_TDATA;
wire    Block_proc_U0_out_r_TVALID;
wire   [3:0] Block_proc_U0_out_r_TKEEP;
wire   [3:0] Block_proc_U0_out_r_TSTRB;
...
wire   [2:0] Block_proc_U0_test_init_arr_V_address0;
