...
set C_modelArgList {
	...
	{ mask int 32 regular  }
	{ test_init_arr_V int 32 regular {array 8 { 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rw", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "test_init_arr_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_r_TDATA sc_out sc_lv 32 signal 8 } 
	{ out_r_TVALID sc_out sc_logic 1 outvld 14 } 
	{ out_r_TREADY sc_in sc_logic 1 outacc 14 } 
	{ out_r_TKEEP sc_out sc_lv 4 signal 9 } 
	{ out_r_TSTRB sc_out sc_lv 4 signal 10 } 
	{ out_r_TUSER sc_out sc_lv 1 signal 11 } 
	{ out_r_TLAST sc_out sc_lv 1 signal 12 } 
	{ out_r_TID sc_out sc_lv 1 signal 13 } 
	{ out_r_TDEST sc_out sc_lv 1 signal 14 } 
	{ mask sc_in sc_lv 32 signal 15 } 
	{ test_init_arr_V_address0 sc_out sc_lv 3 signal 16 } 
	{ test_init_arr_V_ce0 sc_out sc_logic 1 signal 16 } 
	{ test_init_arr_V_q0 sc_in sc_lv 32 signal 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "test_init_arr_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "test_init_arr_V", "role": "address0" }} , 
 	{ "name": "test_init_arr_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "test_init_arr_V", "role": "ce0" }} , 
 	{ "name": "test_init_arr_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "test_init_arr_V", "role": "q0" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "in_V_data_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_data_V"}]},
			{"Name" : "in_V_keep_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_keep_V"}]},
			{"Name" : "in_V_strb_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_strb_V"}]},
			{"Name" : "in_V_user_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_user_V"}]},
			{"Name" : "in_V_last_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_last_V"}]},
			{"Name" : "in_V_id_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_id_V"}]},
			{"Name" : "in_V_dest_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_mem_read_fu_96", "Port" : "in_stream_V_dest_V"}]},
			{"Name" : "out_V_data_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_data_V"}]},
			{"Name" : "out_V_keep_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_keep_V"}]},
			{"Name" : "out_V_strb_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_strb_V"}]},
			{"Name" : "out_V_user_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_user_V"}]},
			{"Name" : "out_V_last_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_last_V"}]},
			{"Name" : "out_V_id_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_id_V"}]},
			{"Name" : "out_V_dest_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "out_stream_V_dest_V"}]},
			{"Name" : "mask", "Type" : "None", "Direction" : "I"},
			{"Name" : "test_init_arr_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_mem_write_fu_74", "Port" : "test_init_arr_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mem_write_fu_74", "Parent" : "0",
		"CDFG" : "mem_write",
		...
		"Port" : [
			...
			{"Name" : "mask", "Type" : "None", "Direction" : "I"},
			{"Name" : "test_init_arr_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mem_read_fu_96", "Parent" : "0",
		"CDFG" : "mem_read",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
...
set Spec2ImplPortList { 
	...
	test_init_arr_V { ap_memory {  { test_init_arr_V_address0 mem_address 1 3 }  { test_init_arr_V_ce0 mem_ce 1 1 }  { test_init_arr_V_q0 mem_dout 0 32 } } }
}
