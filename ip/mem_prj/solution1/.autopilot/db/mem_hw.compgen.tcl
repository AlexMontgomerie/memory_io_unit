...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 34 \
			corename mem_hw_CONTROL_BUS_axilite \
			name mem_hw_CONTROL_BUS_s_axi \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mem_hw_CONTROL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TDEST { O 1 vector } out_r_TVALID { O 1 bit } out_r_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_r_TDEST { I 1 vector } in_r_TVALID { I 1 bit } in_r_TREADY { O 1 bit } } \
} "
} else {
