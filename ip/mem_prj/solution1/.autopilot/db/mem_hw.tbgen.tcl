set C_TypeInfoList {{ 
"mem_hw" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"out": [[], {"reference": "0"}] }, {"in": [[], {"reference": "0"}] }, {"rw": [[], {"scalar": "int"}] }, {"mask": [[], {"scalar": "unsigned int"}] }, {"test_init_arr": [[], {"array": ["1", [256]]}] }],[],""], 
...
set C_modelArgList {
	...
	{ test_init_arr_V int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "out.V.data.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "mask", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mask","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "test_init_arr_V", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_memory","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "test_init_arr.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 255,"step" : 1}]}]}], "offset" : {"in":1024}, "offset_end" : {"in":2047}} ]}
# RTL Port declarations: 
set portNum 38
set portList { 
	{ s_axi_CONTROL_BUS_AWVALID sc_in sc_logic 1 signal -1 } 
	{ s_axi_CONTROL_BUS_AWREADY sc_out sc_logic 1 signal -1 } 
	{ s_axi_CONTROL_BUS_AWADDR sc_in sc_lv 11 signal -1 } 
	...
	{ s_axi_CONTROL_BUS_ARADDR sc_in sc_lv 11 signal -1 } 
	...
	{ in_r_TDATA sc_in sc_lv 32 signal 7 } 
	{ in_r_TKEEP sc_in sc_lv 4 signal 8 } 
	{ in_r_TSTRB sc_in sc_lv 4 signal 9 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"mem_hw","role":"start","value":"0","valid_bit":"0"},{"name":"mem_hw","role":"continue","value":"0","valid_bit":"4"},{"name":"mem_hw","role":"auto_start","value":"0","valid_bit":"7"},{"name":"rw","role":"data","value":"16"},{"name":"mask","role":"data","value":"24"},{"name":"test_init_arr_V","role":"data","value":"1024"}] },
	...
	{ "name": "s_axi_CONTROL_BUS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "ARADDR" },"address":[{"name":"mem_hw","role":"start","value":"0","valid_bit":"0"},{"name":"mem_hw","role":"done","value":"0","valid_bit":"1"},{"name":"mem_hw","role":"idle","value":"0","valid_bit":"2"},{"name":"mem_hw","role":"ready","value":"0","valid_bit":"3"},{"name":"mem_hw","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"VariableLatency" : "1",
		"InputProcess" : [
			{"ID" : "4", "Name" : "mem_read_U0", "ReadyCount" : "mem_read_U0_ap_ready_count"},
			{"ID" : "2", "Name" : "mem_hw_entry3_U0", "ReadyCount" : "mem_hw_entry3_U0_ap_ready_count"},
			{"ID" : "5", "Name" : "mem_write_U0", "ReadyCount" : "mem_write_U0_ap_ready_count"}],
		"OutputProcess" : [
			{"ID" : "5", "Name" : "mem_write_U0"}],
		"Port" : [
			{"Name" : "out_V_data_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_data_V"}]},
			{"Name" : "out_V_keep_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_keep_V"}]},
			{"Name" : "out_V_strb_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_strb_V"}]},
			{"Name" : "out_V_user_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_user_V"}]},
			{"Name" : "out_V_last_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_last_V"}]},
			{"Name" : "out_V_id_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_id_V"}]},
			{"Name" : "out_V_dest_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "out_stream_V_dest_V"}]},
			{"Name" : "in_V_data_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_data_V"}]},
			{"Name" : "in_V_keep_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_keep_V"}]},
			{"Name" : "in_V_strb_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_strb_V"}]},
			{"Name" : "in_V_user_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_user_V"}]},
			{"Name" : "in_V_last_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_last_V"}]},
			{"Name" : "in_V_id_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_id_V"}]},
			{"Name" : "in_V_dest_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "mem_read_U0", "Port" : "in_stream_V_dest_V"}]},
			{"Name" : "rw", "Type" : "None", "Direction" : "I"},
			{"Name" : "mask", "Type" : "None", "Direction" : "I"},
			{"Name" : "test_init_arr_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mem_write_U0", "Port" : "test_init_arr_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mem_hw_CONTROL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mem_hw_entry3_U0", "Parent" : "0",
		"CDFG" : "mem_hw_entry3",
		...
		"Port" : [
			{"Name" : "mask", "Type" : "None", "Direction" : "I"},
			{"Name" : "mask_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "6",
				"BlockSignal" : [
					{"Name" : "mask_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mem_hw_entry28_U0", "Parent" : "0",
		"CDFG" : "mem_hw_entry28",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"VariableLatency" : "0",
		"StartSource" : "2",
		"StartFifo" : "start_for_mem_hw_bkb_U",
		"Port" : [
			{"Name" : "mask", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "6",
				"BlockSignal" : [
					{"Name" : "mask_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "mask_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "5", "DependentChan" : "7",
				"BlockSignal" : [
					{"Name" : "mask_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mem_read_U0", "Parent" : "0",
		"CDFG" : "mem_read",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mem_write_U0", "Parent" : "0",
		"CDFG" : "mem_write",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "mask", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "7",
				"BlockSignal" : [
					{"Name" : "mask_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "test_init_arr_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mask_channel1_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mask_channel_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_mem_hw_bkb_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1048325", "Max" : "1048325"}
