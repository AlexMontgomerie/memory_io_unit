...
set structArgument0 [list 64 1 1 1 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axiu<64, 1, 1, 1>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set structArgument1 [list 64 1 1 1 ]
set NameSpace1 [list ]
set structIsPacked1 "0"
set DataType1 [list "ap_axiu<64, 1, 1, 1>" "struct ap_axiu" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
