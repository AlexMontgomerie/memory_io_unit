...
architecture behave of mem_hw_CONTROL_BUS_s_axi is
    ...
    constant ADDR_MASK_CTRL            : INTEGER := 16#01c#;
    constant ADDR_TEST_INIT_ARR_V_BASE : INTEGER := 16#400#;
    constant ADDR_TEST_INIT_ARR_V_HIGH : INTEGER := 16#7ff#;
...
-- ----------------------- Memory logic ------------------
    ...
    int_test_init_arr_V_address1 <= raddr(9 downto 2) when ar_hs = '1' else waddr(9 downto 2);
