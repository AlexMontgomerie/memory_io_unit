        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MASK_DATA_1 =>
                        rdata_data <= RESIZE(int_mask(63 downto 32), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MASK_DATA_1) then
                    int_mask(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_mask(63 downto 32));
                end if;
            end if;
        end if;
    end process;
