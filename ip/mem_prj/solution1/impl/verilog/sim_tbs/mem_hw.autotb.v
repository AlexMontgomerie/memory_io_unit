...
`define AUTOTB_TVIN_out_V_data_V  "./c.mem_hw.autotvin_out_V_data_V.dat"
`define AUTOTB_TVIN_out_V_keep_V  "./c.mem_hw.autotvin_out_V_keep_V.dat"
`define AUTOTB_TVIN_out_V_strb_V  "./c.mem_hw.autotvin_out_V_strb_V.dat"
`define AUTOTB_TVIN_out_V_user_V  "./c.mem_hw.autotvin_out_V_user_V.dat"
`define AUTOTB_TVIN_out_V_last_V  "./c.mem_hw.autotvin_out_V_last_V.dat"
`define AUTOTB_TVIN_out_V_id_V  "./c.mem_hw.autotvin_out_V_id_V.dat"
`define AUTOTB_TVIN_out_V_dest_V  "./c.mem_hw.autotvin_out_V_dest_V.dat"
`define AUTOTB_TVIN_in_V_data_V  "./c.mem_hw.autotvin_in_V_data_V.dat"
`define AUTOTB_TVIN_in_V_keep_V  "./c.mem_hw.autotvin_in_V_keep_V.dat"
`define AUTOTB_TVIN_in_V_strb_V  "./c.mem_hw.autotvin_in_V_strb_V.dat"
`define AUTOTB_TVIN_in_V_user_V  "./c.mem_hw.autotvin_in_V_user_V.dat"
`define AUTOTB_TVIN_in_V_last_V  "./c.mem_hw.autotvin_in_V_last_V.dat"
`define AUTOTB_TVIN_in_V_id_V  "./c.mem_hw.autotvin_in_V_id_V.dat"
`define AUTOTB_TVIN_in_V_dest_V  "./c.mem_hw.autotvin_in_V_dest_V.dat"
`define AUTOTB_TVIN_mask  "./c.mem_hw.autotvin_mask.dat"
`define AUTOTB_TVIN_test_init_arr_V  "./c.mem_hw.autotvin_test_init_arr_V.dat"
`define AUTOTB_TVIN_out_V_data_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_data_V.dat"
`define AUTOTB_TVIN_out_V_keep_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_keep_V.dat"
`define AUTOTB_TVIN_out_V_strb_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_strb_V.dat"
`define AUTOTB_TVIN_out_V_user_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_user_V.dat"
`define AUTOTB_TVIN_out_V_last_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_last_V.dat"
`define AUTOTB_TVIN_out_V_id_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_id_V.dat"
`define AUTOTB_TVIN_out_V_dest_V_out_wrapc  "./rtl.mem_hw.autotvin_out_V_dest_V.dat"
`define AUTOTB_TVIN_in_V_data_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_data_V.dat"
`define AUTOTB_TVIN_in_V_keep_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_keep_V.dat"
`define AUTOTB_TVIN_in_V_strb_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_strb_V.dat"
`define AUTOTB_TVIN_in_V_user_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_user_V.dat"
`define AUTOTB_TVIN_in_V_last_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_last_V.dat"
`define AUTOTB_TVIN_in_V_id_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_id_V.dat"
`define AUTOTB_TVIN_in_V_dest_V_out_wrapc  "./rtl.mem_hw.autotvin_in_V_dest_V.dat"
`define AUTOTB_TVIN_mask_out_wrapc  "./rtl.mem_hw.autotvin_mask.dat"
`define AUTOTB_TVIN_test_init_arr_V_out_wrapc  "./rtl.mem_hw.autotvin_test_init_arr_V.dat"
`define AUTOTB_TVOUT_out_V_data_V  "./c.mem_hw.autotvout_out_V_data_V.dat"
`define AUTOTB_TVOUT_out_V_keep_V  "./c.mem_hw.autotvout_out_V_keep_V.dat"
`define AUTOTB_TVOUT_out_V_strb_V  "./c.mem_hw.autotvout_out_V_strb_V.dat"
`define AUTOTB_TVOUT_out_V_user_V  "./c.mem_hw.autotvout_out_V_user_V.dat"
`define AUTOTB_TVOUT_out_V_last_V  "./c.mem_hw.autotvout_out_V_last_V.dat"
`define AUTOTB_TVOUT_out_V_id_V  "./c.mem_hw.autotvout_out_V_id_V.dat"
`define AUTOTB_TVOUT_out_V_dest_V  "./c.mem_hw.autotvout_out_V_dest_V.dat"
`define AUTOTB_TVOUT_out_V_data_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_data_V.dat"
`define AUTOTB_TVOUT_out_V_keep_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_keep_V.dat"
`define AUTOTB_TVOUT_out_V_strb_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_strb_V.dat"
`define AUTOTB_TVOUT_out_V_user_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_user_V.dat"
`define AUTOTB_TVOUT_out_V_last_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_last_V.dat"
`define AUTOTB_TVOUT_out_V_id_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_id_V.dat"
`define AUTOTB_TVOUT_out_V_dest_V_out_wrapc  "./impl_rtl.mem_hw.autotvout_out_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1048325;
parameter LENGTH_out_V_data_V = 1048320;
parameter LENGTH_out_V_keep_V = 1048320;
parameter LENGTH_out_V_strb_V = 1048320;
parameter LENGTH_out_V_user_V = 1048320;
parameter LENGTH_out_V_last_V = 1048320;
parameter LENGTH_out_V_id_V = 1048320;
parameter LENGTH_out_V_dest_V = 1048320;
parameter LENGTH_in_V_data_V = 1048320;
parameter LENGTH_in_V_keep_V = 1048320;
parameter LENGTH_in_V_strb_V = 1048320;
parameter LENGTH_in_V_user_V = 1048320;
parameter LENGTH_in_V_last_V = 1048320;
parameter LENGTH_in_V_id_V = 1048320;
parameter LENGTH_in_V_dest_V = 1048320;
parameter LENGTH_mask = 1;
parameter LENGTH_test_init_arr_V = 256;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_data_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_data_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_data_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_data_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_data_V.dat with impl_rtl.mem_hw.autotvout_out_V_data_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_keep_V.dat with impl_rtl.mem_hw.autotvout_out_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_strb_V.dat with impl_rtl.mem_hw.autotvout_out_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_user_V.dat with impl_rtl.mem_hw.autotvout_out_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_last_V.dat with impl_rtl.mem_hw.autotvout_out_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_id_V.dat with impl_rtl.mem_hw.autotvout_out_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.mem_hw.autotvout_out_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.mem_hw.autotvout_out_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mem_hw.autotvout_out_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mem_hw.autotvout_out_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.mem_hw.autotvout_out_V_dest_V.dat with impl_rtl.mem_hw.autotvout_out_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
