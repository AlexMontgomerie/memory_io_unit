...
module AESL_deadlock_report_unit #( parameter PROC_NUM = 4 ) (
    ...
    function [272:0] proc_path(input [PROC_NUM - 1:0] dl_vec);
        ...
        begin
            ...
            case (index)
                0 : begin
                    proc_path = "mem_hw.mem_hw_entry3_U0";
                end
                1 : begin
                    proc_path = "mem_hw.mem_hw_entry28_U0";
                end
                2 : begin
        ...
        begin
            ...
            case (index1)
                0 : begin
                    case(index2)
                    1: begin
                        if (~AESL_inst_mem_hw.mem_hw_entry3_U0.mask_out_blk_n) begin
                            chan_path = "mem_hw.mask_channel1_U";
                            if (~AESL_inst_mem_hw.mask_channel1_U.if_empty_n) begin
                                $display("//      Channel: %0s, EMPTY", chan_path);
                            end
                            else if (~AESL_inst_mem_hw.mask_channel1_U.if_full_n) begin
                        ...
                        if ((~AESL_inst_mem_hw.start_for_mem_hw_bkb_U.if_full_n & AESL_inst_mem_hw.mem_hw_entry28_U0.ap_done)) begin
                            chan_path = "";
                            if ((~AESL_inst_mem_hw.start_for_mem_hw_bkb_U.if_full_n & AESL_inst_mem_hw.mem_hw_entry28_U0.ap_done)) begin
                    ...
                    2: begin
                        if (((AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_hw_entry3_U0.ap_idle & ~(AESL_inst_mem_hw.mem_read_U0_ap_ready_count[0]))) begin
                            chan_path = "";
                            if (((AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_hw_entry3_U0.ap_idle & ~(AESL_inst_mem_hw.mem_read_U0_ap_ready_count[0]))) begin
                    ...
                    3: begin
                        if (((AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_hw_entry3_U0.ap_idle & ~(AESL_inst_mem_hw.mem_write_U0_ap_ready_count[0]))) begin
                            chan_path = "";
                            if (((AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_hw_entry3_U0.ap_idle & ~(AESL_inst_mem_hw.mem_write_U0_ap_ready_count[0]))) begin
                                $display("//      Deadlocked by sync logic between input processes");
                                $display("//      Please increase channel depth");
                ...
                1 : begin
                    case(index2)
                    0: begin
                        if (~AESL_inst_mem_hw.mem_hw_entry28_U0.mask_blk_n) begin
                            chan_path = "mem_hw.mask_channel1_U";
                            if (~AESL_inst_mem_hw.mask_channel1_U.if_empty_n) begin
                                $display("//      Channel: %0s, EMPTY", chan_path);
                            end
                        ...
                        if ((~AESL_inst_mem_hw.start_for_mem_hw_bkb_U.if_empty_n & (AESL_inst_mem_hw.mem_hw_entry28_U0.ap_ready | AESL_inst_mem_hw.mem_hw_entry28_U0.ap_idle))) begin
                            chan_path = "";
                            if ((~AESL_inst_mem_hw.start_for_mem_hw_bkb_U.if_empty_n & (AESL_inst_mem_hw.mem_hw_entry28_U0.ap_ready | AESL_inst_mem_hw.mem_hw_entry28_U0.ap_idle))) begin
                                $display("//      Deadlocked by ap_start, please disable start propagation with:");
                                $display("//      config_rtl -disable_start_propagation");
                    ...
                    3: begin
                        if (~AESL_inst_mem_hw.mem_hw_entry28_U0.mask_out_blk_n) begin
                            chan_path = "mem_hw.mask_channel_U";
                            if (~AESL_inst_mem_hw.mask_channel_U.if_empty_n) begin
                                $display("//      Channel: %0s, EMPTY", chan_path);
                            end
                            else if (~AESL_inst_mem_hw.mask_channel_U.if_full_n) begin
                                $display("//      Channel: %0s, FULL", chan_path);
                            end
                            else begin
                                $display("//      Channel: %0s", chan_path);
                ...
                2 : begin
                    case(index2)
                    0: begin
                        if (((AESL_inst_mem_hw.mem_read_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_read_U0.ap_idle & ~(AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]))) begin
                            chan_path = "";
                            if (((AESL_inst_mem_hw.mem_read_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_read_U0.ap_idle & ~(AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]))) begin
                                $display("//      Deadlocked by sync logic between input processes");
                                $display("//      Please increase channel depth");
                ...
                3 : begin
                    case(index2)
                    1: begin
                        if (~AESL_inst_mem_hw.mem_write_U0.mask_blk_n) begin
                            chan_path = "mem_hw.mask_channel_U";
                            if (~AESL_inst_mem_hw.mask_channel_U.if_empty_n) begin
                                $display("//      Channel: %0s, EMPTY", chan_path);
                            end
                    ...
                    0: begin
                        if (((AESL_inst_mem_hw.mem_write_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_write_U0.ap_idle & ~(AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]))) begin
                            chan_path = "";
                            if (((AESL_inst_mem_hw.mem_write_U0_ap_ready_count[0]) & AESL_inst_mem_hw.mem_write_U0.ap_idle & ~(AESL_inst_mem_hw.mem_hw_entry3_U0_ap_ready_count[0]))) begin
                                $display("//      Deadlocked by sync logic between input processes");
                                $display("//      Please increase channel depth");
