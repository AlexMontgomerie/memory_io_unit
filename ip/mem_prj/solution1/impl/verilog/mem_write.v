...
reg   [0:0] exitcond_flatten_reg_291;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] ap_reg_pp0_iter1_exitcond_flatten_reg_291;
reg    mask_blk_n;
reg   [19:0] indvar_flatten_reg_157;
reg   [11:0] i_i_reg_168;
reg   [0:0] axi_user_V_reg_179;
reg   [8:0] j_i_reg_194;
reg   [31:0] mask_read_reg_286;
reg    ap_block_state1;
wire   [0:0] exitcond_flatten_fu_205_p2;
...
wire   [19:0] indvar_flatten_next_fu_211_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [11:0] tmp_i_mid2_v_v_fu_237_p3;
reg   [11:0] tmp_i_mid2_v_v_reg_300;
wire   [0:0] axi_last_V_fu_263_p2;
reg   [0:0] axi_last_V_reg_305;
wire   [8:0] j_fu_274_p2;
wire   [31:0] axi_data_V_fu_280_p2;
reg    ap_block_pp0_stage0_flag00011011;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [11:0] i_i_phi_fu_172_p4;
reg   [0:0] axi_user_V_phi_fu_185_p4;
wire   [63:0] tmp_4_i_fu_269_p1;
wire    ap_block_pp0_stage0_flag00001001;
wire   [0:0] exitcond_i6_fu_217_p2;
wire   [11:0] i4_fu_231_p2;
wire   [8:0] j_i_mid2_fu_223_p3;
wire   [19:0] j_cast3_i_fu_253_p1;
wire   [19:0] tmp_i_mid2_fu_245_p3;
wire   [19:0] tmp_2_i_fu_257_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state5) & ~((1'b0 == out_stream_V_data_V_1_ack_in) | (1'b0 == out_stream_V_keep_V_1_ack_in) | (1'b0 == out_stream_V_strb_V_1_ack_in) | (1'b0 == out_stream_V_user_V_1_ack_in) | (1'b0 == out_stream_V_last_V_1_ack_in) | (1'b0 == out_stream_V_id_V_1_ack_in) | (1'b0 == out_stream_V_dest_V_1_ack_in)))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'b1 == ap_condition_pp0_exit_iter0_state2))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (ap_done_reg == 1'b1) | (1'b0 == mask_empty_n)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_291) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
        axi_user_V_reg_179 <= 1'd0;
    end else if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (ap_done_reg == 1'b1) | (1'b0 == mask_empty_n)))) begin
        axi_user_V_reg_179 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_flatten_reg_291) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd0 == exitcond_flatten_fu_205_p2))) begin
        indvar_flatten_reg_157 <= indvar_flatten_next_fu_211_p2;
    end else if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (ap_done_reg == 1'b1) | (1'b0 == mask_empty_n)))) begin
        indvar_flatten_reg_157 <= 20'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == exitcond_flatten_fu_205_p2))) begin
        axi_last_V_reg_305 <= axi_last_V_fu_263_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & ~((1'b0 == ap_start) | (ap_done_reg == 1'b1) | (1'b0 == mask_empty_n)))) begin
...
always @ (*) begin
    if ((1'd1 == exitcond_flatten_fu_205_p2)) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_291))) begin
        axi_user_V_phi_fu_185_p4 = 1'd0;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == exitcond_flatten_reg_291))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == exitcond_flatten_reg_291)) | ((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_291)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == exitcond_flatten_fu_205_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == exitcond_flatten_fu_205_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_state1 = ((1'b0 == ap_start) | (ap_done_reg == 1'b1) | (1'b0 == mask_empty_n));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_io = ((1'd0 == exitcond_flatten_reg_291) & (1'b0 == out_stream_V_data_V_1_ack_in));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_291) & (1'b0 == out_stream_V_data_V_1_ack_in));
end
...
assign axi_data_V_fu_280_p2 = (test_init_arr_V_q0 & mask_read_reg_286);

assign axi_last_V_fu_263_p2 = ((tmp_2_i_fu_257_p2 == 20'd1048319) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_205_p2 = ((indvar_flatten_reg_157 == 20'd1048320) ? 1'b1 : 1'b0);

assign exitcond_i6_fu_217_p2 = ((j_i_reg_194 == 9'd256) ? 1'b1 : 1'b0);

assign i4_fu_231_p2 = (i_i_phi_fu_172_p4 + 12'd1);

assign indvar_flatten_next_fu_211_p2 = (indvar_flatten_reg_157 + 20'd1);

assign j_cast3_i_fu_253_p1 = j_i_mid2_fu_223_p3;

assign j_fu_274_p2 = (j_i_mid2_fu_223_p3 + 9'd1);

assign j_i_mid2_fu_223_p3 = ((exitcond_i6_fu_217_p2[0:0] === 1'b1) ? 9'd0 : j_i_reg_194);
...
assign test_init_arr_V_address0 = tmp_4_i_fu_269_p1;

assign tmp_2_i_fu_257_p2 = (j_cast3_i_fu_253_p1 + tmp_i_mid2_fu_245_p3);

assign tmp_4_i_fu_269_p1 = j_i_mid2_fu_223_p3;

assign tmp_i_mid2_fu_245_p3 = {{tmp_i_mid2_v_v_fu_237_p3}, {8'd0}};

assign tmp_i_mid2_v_v_fu_237_p3 = ((exitcond_i6_fu_217_p2[0:0] === 1'b1) ? i4_fu_231_p2 : i_i_phi_fu_172_p4);
