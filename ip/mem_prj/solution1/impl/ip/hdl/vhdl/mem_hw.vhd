...
entity mem_hw is
generic (
    C_S_AXI_CONTROL_BUS_ADDR_WIDTH : INTEGER := 11;
...
architecture behav of mem_hw is 
    ...
    "mem_hw,hls_ip_2017_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=800.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.296917,HLS_SYN_LAT=1048325,HLS_SYN_TPT=1048324,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=408,HLS_SYN_LUT=975}";
    ...
    signal mem_hw_entry3_U0_ap_start : STD_LOGIC;
    signal mem_hw_entry3_U0_start_full_n : STD_LOGIC;
    signal mem_hw_entry3_U0_ap_done : STD_LOGIC;
    signal mem_hw_entry3_U0_ap_continue : STD_LOGIC;
    signal mem_hw_entry3_U0_ap_idle : STD_LOGIC;
    signal mem_hw_entry3_U0_ap_ready : STD_LOGIC;
    signal mem_hw_entry3_U0_start_out : STD_LOGIC;
    signal mem_hw_entry3_U0_start_write : STD_LOGIC;
    signal mem_hw_entry3_U0_mask_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal mem_hw_entry3_U0_mask_out_write : STD_LOGIC;
    signal mem_hw_entry28_U0_ap_start : STD_LOGIC;
    signal mem_hw_entry28_U0_ap_done : STD_LOGIC;
    signal mem_hw_entry28_U0_ap_continue : STD_LOGIC;
    signal mem_hw_entry28_U0_ap_idle : STD_LOGIC;
    signal mem_hw_entry28_U0_ap_ready : STD_LOGIC;
    signal mem_hw_entry28_U0_mask_read : STD_LOGIC;
    signal mem_hw_entry28_U0_mask_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal mem_hw_entry28_U0_mask_out_write : STD_LOGIC;
    ...
    signal mask_channel1_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal mask_channel1_empty_n : STD_LOGIC;
    signal mask_channel_full_n : STD_LOGIC;
    signal mask_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_sync_reg_mem_hw_entry3_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_mem_hw_entry3_U0_ap_ready : STD_LOGIC;
    signal mem_hw_entry3_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal start_for_mem_hw_entry28_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_mem_hw_entry28_U0_full_n : STD_LOGIC;
    signal start_for_mem_hw_entry28_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_mem_hw_entry28_U0_empty_n : STD_LOGIC;
    signal mem_hw_entry28_U0_start_full_n : STD_LOGIC;
    signal mem_hw_entry28_U0_start_write : STD_LOGIC;
    ...
    port (
        ...
        mask_out_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        mask_out_full_n : IN STD_LOGIC;
        mask_out_write : OUT STD_LOGIC );
    end component;


    component mem_hw_entry28 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component start_for_mem_hw_bkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    mem_hw_entry3_U0 : component mem_hw_entry3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    mem_hw_entry28_U0 : component mem_hw_entry28
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    mask_channel1_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    mask_channel_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_mem_hw_bkb_U : component start_for_mem_hw_bkb
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_mem_hw_entry3_U0_ap_ready_assign_proc : process(ap_clk)
    begin
    ...
    mem_hw_entry3_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sync_ready) and (mem_hw_entry3_U0_ap_ready = ap_const_logic_0))) then 
                mem_hw_entry3_U0_ap_ready_count <= std_logic_vector(unsigned(mem_hw_entry3_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = mem_hw_entry3_U0_ap_ready))) then 
                mem_hw_entry3_U0_ap_ready_count <= std_logic_vector(unsigned(mem_hw_entry3_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((mem_read_U0_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_sync_ready))) then 
                mem_read_U0_ap_ready_count <= std_logic_vector(unsigned(mem_read_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = mem_read_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                mem_read_U0_ap_ready_count <= std_logic_vector(unsigned(mem_read_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sync_ready) and (mem_write_U0_ap_ready = ap_const_logic_0))) then 
                mem_write_U0_ap_ready_count <= std_logic_vector(unsigned(mem_write_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = mem_write_U0_ap_ready))) then 
                mem_write_U0_ap_ready_count <= std_logic_vector(unsigned(mem_write_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ap_done <= mem_write_U0_ap_done;
    ap_idle <= (mem_hw_entry3_U0_ap_idle and mem_hw_entry28_U0_ap_idle and mem_read_U0_ap_idle and mem_write_U0_ap_idle);
    ...
    ap_sync_mem_hw_entry3_U0_ap_ready <= (mem_hw_entry3_U0_ap_ready or ap_sync_reg_mem_hw_entry3_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_mem_read_U0_ap_ready and ap_sync_mem_hw_entry3_U0_ap_ready and ap_sync_mem_write_U0_ap_ready);
    in_r_TREADY <= mem_read_U0_in_r_TREADY;
    mem_hw_entry28_U0_ap_continue <= ap_const_logic_1;
    mem_hw_entry28_U0_ap_start <= start_for_mem_hw_entry28_U0_empty_n;
    ...
    mem_hw_entry3_U0_ap_start <= (ap_start and (ap_sync_reg_mem_hw_entry3_U0_ap_ready xor ap_const_logic_1));
    mem_hw_entry3_U0_start_full_n <= (ap_const_logic_0 or start_for_mem_hw_entry28_U0_full_n);
    mem_read_U0_ap_continue <= ap_const_logic_1;
    mem_read_U0_ap_start <= (ap_start and (ap_sync_reg_mem_read_U0_ap_ready xor ap_const_logic_1));
    ...
    mem_write_U0_ap_start <= (ap_start and (ap_sync_reg_mem_write_U0_ap_ready xor ap_const_logic_1));
    ...
    out_r_TUSER <= mem_write_U0_out_r_TUSER;
    out_r_TVALID <= mem_write_U0_out_r_TVALID;
    start_for_mem_hw_entry28_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
