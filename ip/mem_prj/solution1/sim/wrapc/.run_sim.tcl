...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx_2017.1/Vivado_HLS/2017.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx_2017.1/Vivado_HLS/2017.1/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx_2017.1/Vivado_HLS/2017.1/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx_2017.1/Vivado_HLS/2017.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/Xilinx_2017.1/Vivado_HLS/2017.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mem_hw.autotvin.dat"
	set constFileTvOut       "mem_hw.autotvout.dat"
	set constFileHdlTvIn     "mem_hw.autohdltvin.dat"
	set constFileHdlTvOut    "mem_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
