...
module AESL_axi_s_out_r (
    ...
    fifo #(1048320, 32) fifo_out_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1048320, 4) fifo_out_r_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1048320, 4) fifo_out_r_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1048320, 1) fifo_out_r_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1048320, 1) fifo_out_r_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1048320, 1) fifo_out_r_TDEST (
        .reset(1'b0),
        .write_clock(clk),
