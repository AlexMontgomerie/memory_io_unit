...
HD_PWD='/home/am9215/memory_io_unit/mem_io_unit_testing.runs/design_1_s00_data_fifo_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_s00_data_fifo_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_s00_data_fifo_3.tcl
