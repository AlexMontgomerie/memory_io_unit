...
HD_PWD='/home/am9215/memory_io_unit/mem_io_unit_testing.runs/design_1_s01_data_fifo_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_s01_data_fifo_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_s01_data_fifo_1.tcl
