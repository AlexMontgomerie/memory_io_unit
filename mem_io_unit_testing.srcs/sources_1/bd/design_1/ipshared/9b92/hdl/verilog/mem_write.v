...
reg   [0:0] ap_reg_pp0_iter1_exitcond_flatten_reg_273;
reg   [19:0] indvar_flatten_reg_139;
reg   [11:0] i_reg_150;
reg   [0:0] axi_user_V_reg_161;
reg   [8:0] j_reg_176;
wire   [0:0] exitcond_flatten_fu_187_p2;
...
wire   [19:0] indvar_flatten_next_fu_193_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [11:0] tmp_mid2_v_v_fu_219_p3;
reg   [11:0] tmp_mid2_v_v_reg_282;
wire   [0:0] axi_last_V_fu_245_p2;
reg   [0:0] axi_last_V_reg_287;
wire   [8:0] j_1_fu_256_p2;
wire   [31:0] axi_data_V_fu_262_p2;
reg    ap_block_pp0_stage0_flag00011011;
reg    ap_condition_pp0_exit_iter0_state2;
reg   [11:0] i_phi_fu_154_p4;
reg   [0:0] axi_user_V_phi_fu_167_p4;
wire   [63:0] tmp_4_fu_251_p1;
wire    ap_block_pp0_stage0_flag00001001;
wire   [0:0] exitcond6_fu_199_p2;
wire   [11:0] i_s_fu_213_p2;
wire   [8:0] j_mid2_fu_205_p3;
wire   [19:0] j_cast3_fu_235_p1;
wire   [19:0] tmp_mid2_fu_227_p3;
wire   [19:0] tmp_2_fu_239_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_273) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
        axi_user_V_reg_161 <= 1'd0;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        axi_user_V_reg_161 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'd0 == exitcond_flatten_reg_273) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
        i_reg_150 <= tmp_mid2_v_v_reg_282;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_reg_150 <= 12'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd0 == exitcond_flatten_fu_187_p2))) begin
        indvar_flatten_reg_139 <= indvar_flatten_next_fu_193_p2;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0))) begin
        ap_reg_pp0_iter1_exitcond_flatten_reg_273 <= exitcond_flatten_reg_273;
        exitcond_flatten_reg_273 <= exitcond_flatten_fu_187_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'd0 == exitcond_flatten_fu_187_p2))) begin
        axi_last_V_reg_287 <= axi_last_V_fu_245_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == out_stream_V_data_V_1_load_A)) begin
        out_stream_V_data_V_1_payload_A <= axi_data_V_fu_262_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == out_stream_V_data_V_1_load_B)) begin
        out_stream_V_data_V_1_payload_B <= axi_data_V_fu_262_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == out_stream_V_last_V_1_load_A)) begin
        out_stream_V_last_V_1_payload_A <= axi_last_V_reg_287;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == out_stream_V_last_V_1_load_B)) begin
        out_stream_V_last_V_1_payload_B <= axi_last_V_reg_287;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == out_stream_V_user_V_1_load_A)) begin
        out_stream_V_user_V_1_payload_A <= axi_user_V_phi_fu_167_p4;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == out_stream_V_user_V_1_load_B)) begin
        out_stream_V_user_V_1_payload_B <= axi_user_V_phi_fu_167_p4;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_block_pp0_stage0_flag00011001 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter0) & (1'd0 == exitcond_flatten_fu_187_p2))) begin
        tmp_mid2_v_v_reg_282 <= tmp_mid2_v_v_fu_219_p3;
    end
end

always @ (*) begin
    if ((1'd1 == exitcond_flatten_fu_187_p2)) begin
...
always @ (*) begin
    if (((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_273))) begin
        axi_user_V_phi_fu_167_p4 = 1'd0;
    end else begin
        axi_user_V_phi_fu_167_p4 = axi_user_V_reg_161;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == exitcond_flatten_reg_273))) begin
        i_phi_fu_154_p4 = tmp_mid2_v_v_reg_282;
    end else begin
        i_phi_fu_154_p4 = i_reg_150;
    end
end

always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'd0 == exitcond_flatten_reg_273)) | ((ap_block_pp0_stage0_flag00000000 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2) & (1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_273)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == exitcond_flatten_fu_187_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b1 == ap_enable_reg_pp0_iter2) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (ap_block_pp0_stage0_flag00011011 == 1'b0) & (1'd1 == exitcond_flatten_fu_187_p2) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_state3_io = ((1'd0 == exitcond_flatten_reg_273) & (1'b0 == out_stream_V_data_V_1_ack_in));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((1'd0 == ap_reg_pp0_iter1_exitcond_flatten_reg_273) & (1'b0 == out_stream_V_data_V_1_ack_in));
end
...
assign axi_data_V_fu_262_p2 = (test_init_arr_V_q0 & mask);

assign axi_last_V_fu_245_p2 = ((tmp_2_fu_239_p2 == 20'd1048319) ? 1'b1 : 1'b0);

assign exitcond6_fu_199_p2 = ((j_reg_176 == 9'd256) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_187_p2 = ((indvar_flatten_reg_139 == 20'd1048320) ? 1'b1 : 1'b0);

assign i_s_fu_213_p2 = (i_phi_fu_154_p4 + 12'd1);

assign indvar_flatten_next_fu_193_p2 = (indvar_flatten_reg_139 + 20'd1);

assign j_1_fu_256_p2 = (j_mid2_fu_205_p3 + 9'd1);

assign j_cast3_fu_235_p1 = j_mid2_fu_205_p3;

assign j_mid2_fu_205_p3 = ((exitcond6_fu_199_p2[0:0] === 1'b1) ? 9'd0 : j_reg_176);
...
assign test_init_arr_V_address0 = tmp_4_fu_251_p1;

assign tmp_2_fu_239_p2 = (j_cast3_fu_235_p1 + tmp_mid2_fu_227_p3);

assign tmp_4_fu_251_p1 = j_mid2_fu_205_p3;

assign tmp_mid2_fu_227_p3 = {{tmp_mid2_v_v_fu_219_p3}, {8'd0}};

assign tmp_mid2_v_v_fu_219_p3 = ((exitcond6_fu_199_p2[0:0] === 1'b1) ? i_s_fu_213_p2 : i_phi_fu_154_p4);
